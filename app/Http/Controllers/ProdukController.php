...
class ProdukController extends Controller
{
    ...
    //     // $path = $request->file('foto_produk')->storeAs('images', $fileName, 'public');
    //     // $requestData["foto_produk"] = '/storage' . $path;
    //     // $produk = Produk::create($request->all());
    //     $produk->foto_produk = $request->foto_produk->store('public/images');
    //     return response()->json('Data berhasil disimpan', 200);
    // }
