            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="file" name="foto_produk" id="foto_produk" class="form-control" accept="image/" required autofocus>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    <button class="btn btn-sm btn-flat btn-primary" id="upload-button"><i class="fa fa-save"></i> Simpan</button>
